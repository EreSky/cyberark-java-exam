...
public class ItemRestIntegrationTest {
    ...
    public void testSetItemRule() throws JSONException {
        ...
        ResponseEntity<Void> responseEntity = restTemplate.exchange("/items/rules?itemType=" + createReturnedItem.getType() + "&itemRuleType=LOSES_CONSTANT_VALUE_WITH_AGE", HttpMethod.PUT, null, Void.class);
